...
import 'package:flutter_ai_app/views/ai_bot/ai_bot_popup_menu.dart';
import 'package:flutter_ai_app/views/ai_bot/chat_bot_screen.dart';
...
class _AIBotState extends State<AIBotView> {
  ...
  void handleOpenChatAssistant(AiBot input) {
    Navigator.push(context, MaterialPageRoute(builder: (_) => ChatBotScreen(data: input)));
  }
