...
class AuthService {
  ...
  Future<User> signUpAccount(String email, String password, String username) async{
  ...
  String handleResponse(String response){
    ...
    if(decodeResponse.containsKey("details") && decodeResponse['details'] is List && !decodeResponse['details'].isEmpty){
